			...
			<div class="col-md-3">
				<ul class="nav nav-pills nav-stacked admin-menu">
					<li class="active"><a href=""
						data-target-id="profile"><i class="glyphicon glyphicon-user"></i>Profile</a></li>
				...
				<form action="updateProfile.do" method="post">
					<table>
						...
						<tr class="panel panel-info">
							...
							<td><input id=aaa type="text" name="name" value="${original.name}">
							</td>
						</tr>
						<tr class="panel panel-info">
						...
						<tr class="panel panel-info">
							...
							<td class="panel-body"><input id=aaa type="hidden" name="id" value="${original.id}">
								<input class="btn btn-primary" type="submit" value="변경"></td>
						</tr>
					</table>
				</form>
				</div>
				...
				<form action="/password" method="post">
					...
					<div class="panel-heading">
							<h3 class="panel-title">
								<label for="new_password" class="control-label panel-title">현재 비밀번호</label>
							</h3>
						</div>
						<div class="panel-body">
					...
					<div class="panel panel-info" style="margin: 1em;">
						<div class="panel-heading">
							<h3 class="panel-title">
								<label for="confirm_password" class="control-label panel-title">Confirm password</label>
							</h3>
						</div>
						<div class="panel-body">
							<div class="form-group">
